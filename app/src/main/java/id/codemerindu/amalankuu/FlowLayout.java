...
public class FlowLayout extends   ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        int sizeWidth = View.MeasureSpec.getSize(widthMeasureSpec) - this.getPaddingRight() - this.getPaddingLeft();
        int sizeHeight = View.MeasureSpec.getSize(heightMeasureSpec) - this.getPaddingRight() - this.getPaddingLeft();
        ...
        for (int i = 0; i < count; i++) {
            ...
            child.measure(
                    View.MeasureSpec.makeMeasureSpec(sizeWidth, modeWidth == View.MeasureSpec.EXACTLY ? View.MeasureSpec.AT_MOST : modeWidth),
                    View.MeasureSpec.makeMeasureSpec(sizeHeight, modeHeight == View.MeasureSpec.EXACTLY ? View.MeasureSpec.AT_MOST : modeHeight)
            );
            ...
            boolean newLine = lp.newLine || (mode != View.MeasureSpec.UNSPECIFIED && lineLength > size);
            if (newLine) {
                if (orientation == HORIZONTAL) {
