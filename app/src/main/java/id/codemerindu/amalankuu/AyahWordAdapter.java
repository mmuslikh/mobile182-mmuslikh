...
import id.codemerindu.amalankuu.database.datasource.AyahWordDataSource;
...
public class AyahWordAdapter  extends RecyclerView.Adapter<AyahWordAdapter.AyahViewHolder> {
    ...
    public void onBindViewHolder(AyahWordAdapter.AyahViewHolder holder, int position) {
        ...
        if (position % 2 == 0) {
            ...
            holder.translate_textView.setBackgroundColor(ContextCompat.getColor(context, R.color.mushaf2));
            ...
            holder.translate_textView.setBackgroundColor(ContextCompat.getColor(context, R.color.mushaf3));
